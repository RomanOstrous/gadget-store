...
export const ProductDetailsPage = () => {
  ...
  const { product, favorites, inCart, isSelectedProduct } =
...
"
              ...
              >
                <div className="product-details__choice">
                  <p className="product-details__text">Available colors</p>
                ...
                <div className="product-details__choice">
                  <p className="product-details__text">Select capacity</p>
                  <div className="product-details__choice-list">
                ...
                <div className="product-details__character">
                  <ul className="product-details__list">
                    {charProd.keys.map(key => (
                      <li key={key} className="product-details__detal-name">
                        {key}
                      </li>
                    ))}
                  </ul>
                  ...
                  <ul className="product-details__list">
                    {charProd.values.map(value => (
                      <li key={value} className="product-details__detal-value">
                        {value}
                      </li>
                    ))}
                  </ul>
